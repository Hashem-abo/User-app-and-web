...
class ZegoExpressEngineMethodHandler {
  ...
  public:
    ...
    void takePublishStreamSnapshotByConfig(ZFArgument argument, ZFResult result);
    ...
    void getVideoDecoderSupported(ZFArgument argument, ZFResult result);
    void setPlayStreamsAlignmentProperty(ZFArgument argument, ZFResult result);
    void setPlayStreamDecodeFrameMode(ZFArgument argument, ZFResult result);
    ...
    void setPlayingCanvas(ZFArgument argument, ZFResult result);
    ...
    void enableBeforeAudioPrepAudioData(ZFArgument argument, ZFResult result);
    ...
    void createCustomAudioSource(ZFArgument argument, ZFResult result);
    void destroyCustomAudioSource(ZFArgument argument, ZFResult result);
    void customAudioSourceStartCapture(ZFArgument argument, ZFResult result);
    void customAudioSourceStopCapture(ZFArgument argument, ZFResult result);
    void customAudioSourceEnableAEC(ZFArgument argument, ZFResult result);
    void customAudioSourceSetVolume(ZFArgument argument, ZFResult result);
    void customAudioSourceMute(ZFArgument argument, ZFResult result);
    void customAudioSourcePushAudioFrame(ZFArgument argument, ZFResult result);
    void sendCustomAudioCaptureAACData(ZFArgument argument, ZFResult result);
    void sendCustomAudioCaptureOpusData(ZFArgument argument, ZFResult result);
    ...
    void setStreamAlignmentProperty(ZFArgument argument, ZFResult result);
    ...
    void getVideoEncoderSupported(ZFArgument argument, ZFResult result);
    ...
    void enableVideoEncoderEnhancement(ZFArgument argument, ZFResult result);
    void enableVideoEncoderEnhancementWithConfig(ZFArgument argument, ZFResult result);
    void enableAuxBgmBalance(ZFArgument argument, ZFResult result);
    void enableFaceDetection(ZFArgument argument, ZFResult result);

    void startPlayingStream(ZFArgument argument, ZFResult result);
    void switchPlayingStream(ZFArgument argument, ZFResult result);
    void switchPlayingResource(ZFArgument argument, ZFResult result);
    ...
    void startRecordingRemoteData(ZFArgument argument, ZFResult result);
    void stopRecordingRemoteData(ZFArgument argument, ZFResult result);
    ...
    // ScreenCapture
    bool isScreenCaptureSourcesValid();
    ...
    void enableHightLightScreenCaptureSource(ZFArgument argument, ZFResult result);
    ...
    void enableAudioCaptureWithConfigScreenCaptureSource(ZFArgument argument, ZFResult result);
    ...
    // Picture Capturer
    void createPictureCapturer(ZFArgument argument, ZFResult result);
    void destroyPictureCapturer(ZFArgument argument, ZFResult result);
    void setPathPictureCapturer(ZFArgument argument, ZFResult result);
  ...
  private:
    ...
    std::unordered_map<int, EXPRESS::IZegoCustomAudioSource *> customAudioSourceMap_;
    ...
    std::unordered_map<int, EXPRESS::IZegoPictureCapturer *> pictureCapturerMap_;
