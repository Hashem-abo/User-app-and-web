...
extension ZegoExpressEngineCustomAudioIO on ZegoExpressEngine {
  ...
  /// Related APIs: Enable the custom audio IO function [enableCustomAudioIO], and start the push stream [startPublishingStream].
  ///
  /// - [data] Opus buffer data.
  /// - [dataLength] The total length of the buffer data.
  /// - [referenceTimeMillisecond] The UNIX timestamp of this Opus audio frame in millisecond.
  /// - [samples] The number of samples for this Opus audio frame.
  /// - [param] The param of this Opus audio frame.
  /// - [channel] Publish channel for capturing audio frames.
  Future<void> sendCustomAudioCaptureOpusData(Uint8List data, int dataLength,
      ...
      {ZegoPublishChannel? channel}) async {
    return await ZegoExpressImpl.instance.sendCustomAudioCaptureOpusData(
        data, dataLength, referenceTimeMillisecond, samples, param,
        channel: channel);
  }
