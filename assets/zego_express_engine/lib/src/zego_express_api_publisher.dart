...
extension ZegoExpressEnginePublisher on ZegoExpressEngine {
  ...
  /// - [codecID] Video codec id. Required: Yes.
  /// - [codecBackend] Backend implementation of encoder. Required: Yes.
  /// - Returns Results of get video encoder supported.
  Future<ZegoPublisherGetVideoEncoderSupportedResult> getVideoEncoderSupported(
      ZegoVideoCodecID codecID,
      {ZegoVideoCodecBackend? codecBackend}) async {
    return await ZegoExpressImpl.instance
        .getVideoEncoderSupported(codecID, codecBackend: codecBackend);
  }
  ...
  /// Note: This function is only available in ZegoExpressVideo SDK!
  ///
  /// - [params] Low light enhancement params.
  /// - [channel] Publish stream channel.
  ...
  /// - [enhanceLevel] enhance_level [0.0,1.5], advise 1.2
  /// - [channel] Publish stream channel.
