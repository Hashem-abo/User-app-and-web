...
ThemeData dark({Color color = const Color(0xFF54b46b), Color disabledColor = const Color(0xffa2a7ad), Color hintColor = const Color(0xFFbebebe), Color cardColor = const Color(0xFF30313C), String? fontFamily}) => ThemeData(
