...
import 'package:suliman/features/chat/widgets/chat_serach_field_widget.dart';
...
import 'package:suliman/features/chat/widgets/web_chat_view_widget.dart';
      ...
      return Scaffold(
        ...
        body: ResponsiveHelper.isDesktop(context) ? WebChatViewWidget(
          ...
          child: Column(children: [
            ...
            ) : Center(child: Text('no_conversation_found'.tr)) : const CustomLoaderWidget() :  NotLoggedInScreen(callBack: (value){
              initCall();
              setState(() {});
            })),
