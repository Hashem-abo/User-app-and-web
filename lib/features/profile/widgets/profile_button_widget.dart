...
class ProfileButtonWidget extends StatelessWidget {
  ...
  const ProfileButtonWidget({super.key, this.icon, required this.title, required this.onTap, this.isButtonActive, this.color, this.iconImage, this.languageName, this.trailingText});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: isButtonActive != null ? 12 : (languageName != null || trailingText != null) ? Dimensions.paddingSizeDefault : Dimensions.paddingSizeLarge),
        ...
        child: Row(children: [
          ...
          ) : trailingText != null ? Row(
            children: [
              Text(trailingText!, style: robotoRegular.copyWith(
                fontSize: Dimensions.fontSizeSmall,
