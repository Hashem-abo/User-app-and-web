                      ...
                      Expanded(child: Container(
                        ...
                        child: Row(children: [
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text(
                              '${'add_fund_to_wallet_minimum'.tr} ${PriceConverter.convertPrice(walletController.fundBonusList![index1].minimumAddAmount)} ${'and_enjoy'.tr} '
                                  '${(walletController.fundBonusList![index1].bonusType == 'amount' && Get.find<SplashController>().configModel!.currencySymbolDirection == 'left') ? Get.find<SplashController>().configModel!.currencySymbol : ''} '
                                  '${walletController.fundBonusList![index1].bonusAmount} '
                                  '${walletController.fundBonusList![index1].bonusType == 'amount' ? (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '') : '%'} ${'bonus'.tr}',
                      ...
                      Expanded(child: hasSecond ? Container(
                        ...
                        child: Row(children: [
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text(
                              '${'add_fund_to_wallet_minimum'.tr} ${PriceConverter.convertPrice(walletController.fundBonusList![index2].minimumAddAmount)} ${'and_enjoy'.tr} '
                                  '${(walletController.fundBonusList![index2].bonusType == 'amount' && Get.find<SplashController>().configModel!.currencySymbolDirection == 'left') ? Get.find<SplashController>().configModel!.currencySymbol : ''} '
                                  '${walletController.fundBonusList![index2].bonusAmount} '
                                  '${walletController.fundBonusList![index2].bonusType == 'amount' ? (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '') : '%'} ${'bonus'.tr}',
                              style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
                            ),
                          ])),
