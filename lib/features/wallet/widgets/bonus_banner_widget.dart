                  ...
                  return Container(
                    ...
                    child: Row(children: [
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Text(
                          '${'add_fund_to_wallet_minimum'.tr} ${PriceConverter.convertPrice(walletController.fundBonusList![index].minimumAddAmount)} ${'and_enjoy'.tr} '
                              '${(walletController.fundBonusList![index].bonusType == 'amount' && Get.find<SplashController>().configModel!.currencySymbolDirection == 'left') ? Get.find<SplashController>().configModel!.currencySymbol : ''} '
                              '${walletController.fundBonusList![index].bonusAmount} '
                              '${walletController.fundBonusList![index].bonusType == 'amount' ? (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '') : '%'} ${'bonus'.tr}',
