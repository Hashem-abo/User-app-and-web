...
import 'package:suliman/features/order/widgets/support_reason_bottom_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      Padding(
        ...
        child: CustomCard(
          borderRadius: Dimensions.radiusDefault, isBorder: false,
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('billing_summary'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            const SizedBox(height: Dimensions.paddingSizeSmall),
