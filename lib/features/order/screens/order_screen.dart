...
import 'package:suliman/features/rental_module/rental_order/widgets/trip_order_view_widget.dart';
...
import 'package:suliman/features/order/widgets/guest_track_order_input_view_widget.dart';
import 'package:suliman/features/order/widgets/order_view_widget.dart';
                    ...
                    ResponsiveHelper.isDesktop(context) ? Container(
                      ...
                      Align(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(text: 'running'.tr, icon: const Icon(Icons.directions_run, size: 20), iconMargin: const EdgeInsets.only(bottom: 5)),
                            Tab(text: 'history'.tr, icon: const Icon(Icons.history, size: 20), iconMargin: const EdgeInsets.only(bottom: 5)),
                          ],
                        ),
                      ),
                    ]),
