...
import 'package:suliman/features/order/widgets/guest_custom_stepper_widget.dart';
import 'package:suliman/features/order/widgets/traking_map_widget.dart';
                    ...
                    child: orderController.trackModel != null ? Column(children: [
                      ...
                      Column(children: [
                        ...
                        GuestCustomStepperWidget(
                          ...
                          trailing: (orderController.trackModel?.deliveryMan?.phone != null && status != AppConstants.delivered && status != AppConstants.failed && status != AppConstants.canceled) ? InkWell(
                            onTap: () async {
