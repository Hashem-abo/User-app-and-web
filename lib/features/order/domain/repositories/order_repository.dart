...
import 'package:suliman/features/order/domain/models/refund_model.dart';
import 'package:suliman/features/order/domain/models/support_model.dart';
...
class OrderRepository implements OrderRepositoryInterface {
  ...
  @override
  Future<Response> checkAiBatching(List<int> storeIds, double lat, double lng) async {
    return await apiClient.postData(AppConstants.preBatchCheckUri, {
      'store_ids': storeIds,
      'latitude': lat,
      'longitude': lng,
    });
