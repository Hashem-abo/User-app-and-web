...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    String? modType = Get.find<SplashController>().module?.moduleType.toString();
    ...
    _screens = [
      ...
      const MenuScreen(),
      const AllStoreScreen(isPopular: true, isFeatured: false, isNearbyStore: true, isTopOfferStore: false, isRecommendedStore: false, backButton: false),
      const ItemViewAllScreen(isSpecial: true, isPopular: false, backButton: false),
  ...
  Future<void> suggestAddressBottomSheet() async {
    ...
    if(widget.fromSplash && Get.find<LocationController>().showLocationSuggestion && active && AddressHelper.getUserAddressFromSharedPref() == null) {
      Future.delayed(const Duration(seconds: 1), () {
        showModalBottomSheet(
          context: Get.context!, isScrollControlled: true, backgroundColor: Colors.transparent,
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SplashController>(
      builder: (splashController) {
        ...
        bool isServices = (splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.services);
        bool isGlobal = (splashController.module != null && splashController.module!.moduleType.toString() == AppConstants.globalShopping);
        ...
        _screens = [
          ...
          isParcel ? const AddressScreen(fromDashboard: true)
              ...
              : isGlobal ? const GlobalHomeScreen()
        ...
        return PopScope(
          ...
          child: GetBuilder<OrderController>(
            builder: (orderController) {
              ...
              bool showRunningOrders = (widget.fromSplash && Get.find<LocationController>().showLocationSuggestion && active && !ResponsiveHelper.isDesktop(context)) ? false
                  : (ResponsiveHelper.isDesktop(context) || !_isLogin || orderController.runningOrderModel == null
                  || orderController.runningOrderModel!.orders!.isEmpty || !orderController.showBottomSheet) ? false : true;
              ...
              return SafeArea(
                ...
                child: Scaffold(
                  ...
                  body: ExpandableBottomSheet(
                      ...
                      PageView.builder(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: ClipOval(
                                      child: (splashController.configModel?.splashScreenImageFullUrl != null)
                                        ? CustomImage(
                                            image: splashController.configModel!.splashScreenImageFullUrl!,
                                            fit: BoxFit.cover,
                                          )
                                        : Image.asset(Images.ucleSul, fit: BoxFit.cover),
                                    ),
                                  ),
                                )
                        ...
                        ResponsiveHelper.isDesktop(context) || keyboardVisible ? const SizedBox() : Align(
                          ...
                          child: GetBuilder<SplashController>(
                            builder: (splashController) {
                                  return Stack(clipBehavior: Clip.none, alignment: Alignment.bottomCenter, children: [
                                  ...
                                  Container(
                                    ...
                                    child: Stack(children: [
                                      ...
                                      showRunningOrders ? const SizedBox() : Center(
                                        child: SizedBox(
                                            width: size.width, height: 80,
                                            child: GetBuilder<CartController>(builder: (cartController) {
                                              return GetBuilder<GlobalCartController>(builder: (globalCartCtrl) {
                                                return Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: _getBottomNavItems(context, isParcel, isTaxi, isServices, isGlobal, cartController));
                                              });
                                            }),
                                        ),
                                      ),
                                  ...
                                  if ((splashController.module?.bottomNavConfig?['middle_button']?['enabled'] ?? false) && !showRunningOrders)
                                    Positioned(
                                      bottom: 30, // Floats the button above the bar
                                      child: Builder(
                                        builder: (context) {
                                           var middleButtonConfig = splashController.module!.bottomNavConfig!['middle_button'];
                                           String? type = middleButtonConfig?['type'];
                                           String? storeId = middleButtonConfig?['store_id']?.toString();
                                           String? itemId = middleButtonConfig?['item_id']?.toString();
                                           String? shelfId = middleButtonConfig?['shelf_id']?.toString();
                                           String? link = middleButtonConfig?['link'];
                                           String? storeLogo = middleButtonConfig?['store_logo'];
                                           // String? iconSource = middleButtonConfig?['icon_source']; // Unused
                                           // String? customIcon = middleButtonConfig?['custom_icon']; // Unused

                                           return InkWell(
                                              onTap: () async {
                                                   int? safeStoreId = (storeId != null && storeId.isNotEmpty) ? int.tryParse(storeId) : null;
                                                   int? safeItemId = (itemId != null && itemId.isNotEmpty) ? int.tryParse(itemId) : null;
                                                   int? safeShelfId = (shelfId != null && shelfId.isNotEmpty) ? int.tryParse(shelfId) : null;

                                                    if (type == 'store' && safeStoreId != null) {
                                                        if (isServices) {
                                                            Get.to(() => ServiceProviderScreen(providerId: safeStoreId));
                                                        } else {
                                                            Get.toNamed(RouteHelper.getStoreRoute(id: safeStoreId, page: 'store'));
                                                        }
                                                    } else if (type == 'item' && safeItemId != null) {
                                                        if (isServices) {
                                                            Get.toNamed(RouteHelper.getServiceDetailsRoute(safeItemId));
                                                        } else {
                                                            Get.toNamed(RouteHelper.getItemDetailsRoute(safeItemId, false));
                                                        }
                                                   } else if (type == 'shelf' && safeShelfId != null) {
                                                        Get.to(() => DynamicShelfViewAllScreen(shelfId: safeShelfId));
                                                   } else if (type == 'url' && link != null && link.isNotEmpty) {
                                                        if(await canLaunchUrlString(link)) {
                                                          launchUrlString(link, mode: LaunchMode.externalApplication);
                                                        }
                                                   } else if (type == 'page' && link != null && link.isNotEmpty) {
                                                        switch(link) {
                                                            case 'item_campaign': 
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      ...
                                                      boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.2), blurRadius: 10, spreadRadius: 2, offset: const Offset(0, -3))],
                                                  ),
                                                  child: (splashController.module?.middleButtonIconFullUrl != null) 
                                                      ? ClipOval(
                                                          child: CustomImage(
                                                              image: splashController.module!.middleButtonIconFullUrl!,
                                                      ...
                                                      : (storeLogo != null)
                                                          ? ClipOval(
                                                              child: CustomImage(
                                                                  image: '${Get.find<SplashController>().configModel?.baseUrls?.storeImageUrl}/$storeLogo',
                                                                  height: 60, width: 60, fit: BoxFit.cover,
                                                              ),
                                                          )
                                                          : Icon(Icons.store, color: Theme.of(context).primaryColor, size: 40),
                                              ).animate(onPlay: (controller) => controller.repeat(reverse: true)).scale(duration: const Duration(milliseconds: 1000), begin: const Offset(1, 1), end: const Offset(1.1, 1.1)),
                                          );
                                        }
                                      ),
                                    ),
                    ...
                    persistentContentHeight: showRunningOrders ? (GetPlatform.isIOS ? 110 : 100) : 0,
                    ...
                    expandableContent: showRunningOrders ? Dismissible(
                      key: UniqueKey(),
  ...
  List<Widget> _getBottomNavItems(BuildContext context, bool isParcel, bool isTaxi, bool isServices, bool isGlobal, CartController cartController) {
    ...
    for (var item in configItems) {
      ...
      String key = item['key'] ?? '';
      bool visible = (item['visible'] == null) ? true : (item['visible'].toString() == 'true' || item['visible'].toString() == '1');
      ...
      if (rawTitles != null && rawTitles is Map) {
        ...
        customTitle = rawTitles[currentLang]?.toString() ?? rawTitles['default']?.toString();
      }
      ...
      if (iconType == 'svg' && iconSvg != null && iconSvg.isNotEmpty) {
          iconUrl = '${Get.find<SplashController>().configModel!.baseUrls!.moduleImageUrl}/nav_icon/$iconSvg';
      }
      
      navWidgets.add(_buildNavItem(key, customTitle, customIconName, iconUrl, isParcel, isTaxi, isServices, cartController, isGlobal: isGlobal));
    }
    
    // Insert Special Middle Button if enabled
    var middleButtonConfig = module?.bottomNavConfig?['middle_button'];
    if (middleButtonConfig != null && (middleButtonConfig['enabled'] ?? false)) {
  ...
  Widget _buildNavItem(String key, String? customTitle, String? customIconName, String? iconUrl, bool isParcel, bool isTaxi, bool isServices, CartController cartController, {bool isGlobal = false}) {
    IconData? customIcon = customIconName != null ? _getIconDataFromString(customIconName) : null;
    final globalCartCtrl = isGlobal ? Get.find<GlobalCartController>() : null;
    ...
    switch (key) {
      ...
      case 'section_1':
        IconData defaultIcon = isParcel ? Icons.location_on_outlined : isTaxi ? Icons.favorite_border : isGlobal ? Icons.home_outlined : isServices ? Icons.home_repair_service_outlined : Icons.grid_view;
        IconData defaultSelected = isParcel ? Icons.location_on : isTaxi ? Icons.favorite : isGlobal ? Icons.home : isServices ? Icons.home_repair_service : Icons.grid_view_rounded;
        String defaultTitle = isParcel ? 'address'.tr : isTaxi ? 'wishlist'.tr : isGlobal ? 'global_shopping'.tr : isServices ? 'services'.tr : 'categories'.tr;
        return BottomNavItemWidget(
      ...
      case 'orders':
        return BottomNavItemWidget(
          title: customTitle ?? (isGlobal ? 'global_my_orders'.tr : 'orders'.tr),
          iconUrl: iconUrl,
      ...
      case 'cart':
        final cartCount = isGlobal ? (globalCartCtrl?.cartList.length ?? 0) : cartController.cartList.length;
        return BottomNavItemWidget(
      ...
      case 'section_2':
        IconData defaultIcon = isTaxi ? Icons.map_outlined : Icons.favorite_outline;
      ...
      case 'nearest_store':
        return BottomNavItemWidget(
          title: customTitle ?? (isServices ? 'nearest_service_provider'.tr : 'nearest_store'.tr),
          iconUrl: iconUrl,
          iconData: customIcon ?? Icons.store_outlined,
          selectedIconData: customIcon != null ? null : Icons.store,
          isSelected: _pageIndex == 6, onTap: () => _setPage(6),
        );
      case 'special_offers':
        return BottomNavItemWidget(
          ...
          isSelected: _pageIndex == 7, onTap: () => _setPage(7),
        );
      case 'campaign':
        return BottomNavItemWidget(
          ...
          isSelected: _pageIndex == 8, onTap: () => _setPage(8),
        );
      case 'trends':
        return BottomNavItemWidget(
          ...
          isSelected: _pageIndex == 10, // Adjust index to your matching PageView/index state
          onTap: () => _setPage(10),
        );
      case 'menu':
        return BottomNavItemWidget(
          ...
          isSelected: _pageIndex == 5, onTap: () => _setPage(5),
        );
      case 'my_bookings':
        return BottomNavItemWidget(
          ...
          onTap: () {
            if(AuthHelper.isLoggedIn()) {
              Get.find<ServiceController>().getBookingList(1).then((value) {
                if (Get.find<ServiceController>().bookings != null && Get.find<ServiceController>().bookings!.isNotEmpty) {
                  bool hasActiveBookings = Get.find<ServiceController>().bookings!.any((b) => b.status != 'completed' && b.status != 'canceled');
