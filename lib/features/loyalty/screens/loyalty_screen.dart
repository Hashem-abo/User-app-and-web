...
import 'package:suliman/features/loyalty/widgets/loyalty_bottom_sheet_widget.dart';
import 'package:suliman/features/loyalty/widgets/loyalty_card_widget.dart';
import 'package:suliman/features/loyalty/widgets/loyalty_history_widget.dart';
      ...
      child: Scaffold(
        ...
        body: GetBuilder<ProfileController>(
            builder: (profileController) {
              ...
              ) : const CustomLoaderWidget() : NotLoggedInScreen(callBack: (value){
                initCall();
                setState(() {});
              });
            }
