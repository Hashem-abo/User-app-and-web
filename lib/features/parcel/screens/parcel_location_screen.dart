...
import 'package:suliman/features/checkout/widgets/tips_widget.dart';
import 'package:suliman/features/dashboard/widgets/parcel_bottom_sheet_widget.dart';
...
import 'package:suliman/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
import 'package:suliman/features/parcel/widgets/parcel_info_bottom_sheet.dart';
import 'package:suliman/features/parcel/widgets/parcel_payment_method_bottom_sheet.dart';
...
class _DeliveryTipsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: _sectionDecoration(context),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('delivery_man_tips'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
        const SizedBox(height: Dimensions.paddingSizeSmall),
        showCustomField
            ? Row(children: [
                Expanded(
