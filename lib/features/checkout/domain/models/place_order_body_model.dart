...
class PlaceOrderBodyModel {
  ...
  PlaceOrderBodyModel({
    ...
    _digitalPaymentGateway = digitalPaymentGateway;
  ...
  String? get digitalPaymentGateway => _digitalPaymentGateway;
  ...
  PlaceOrderBodyModel.fromJson(Map<String, dynamic> json) {
    ...
    _digitalPaymentGateway = json['digital_payment_gateway'];
  ...
  Map<String, String> toJson() {
    ...
    if(_storeDistances != null) {
      data['store_distances'] = jsonEncode(_storeDistances);
    }
    if (_digitalPaymentGateway != null) {
      data['digital_payment_gateway'] = _digitalPaymentGateway!;
    }
    if (_purchaseCode != null) {
      data['purchase_code'] = _purchaseCode!;
    }
    if (_productReferrerId != null) {
      data['product_referrer_id'] = _productReferrerId!;
    }
    if (_saverDeliveryType != null) {
...
class OnlineCart {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['model'] = _model;
    data['item_type'] = _itemType ?? (_model == 'ItemCampaign' ? 'App\\Models\\ItemCampaign' : 'App\\Models\\Item');
    data['note'] = _note;
    return data;
  }
}
