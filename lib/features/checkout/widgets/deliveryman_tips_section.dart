            ...
            (!widget.takeAway && Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? Container(
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  ...
                  title: Row(children: [
                    Icon(Icons.volunteer_activism_outlined, color: Theme.of(context).primaryColor, size: 20),
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Text('delivery_man_tips'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    ...
                    children: [
                      Text(
                        checkoutController.tips > 0
                            ? PriceConverter.convertPrice(checkoutController.tips, forDM: true)
                            : 'not_now'.tr,
