...
class PaymentSection extends StatelessWidget {
  ...
  const PaymentSection({super.key, this.storeId, required this.isCashOnDeliveryActive, required this.isDigitalPaymentActive,
    required this.isWalletActive, required this.total, required this.checkoutController, required this.isOfflinePaymentActive, this.cartList,
  });
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text((storeId == null || (cartList != null && cartList!.isNotEmpty)) ? 'choose_payment_method'.tr : 'payment_method'.tr, style: robotoMedium),

        (storeId == null || (cartList != null && cartList!.isNotEmpty)) && !ResponsiveHelper.isDesktop(context) ? InkWell(
          onTap: (){
