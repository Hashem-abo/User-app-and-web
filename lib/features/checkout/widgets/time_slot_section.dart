...
class TimeSlotSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: ((checkoutController.selectedDateSlot == 0 && todayClosed) || (checkoutController.selectedDateSlot == 1 && tomorrowClosed))
                    ...
                    : Text(checkoutController.preferableTime.isNotEmpty ? '${checkoutController.selectedDateSlot == 0 ? 'today'.tr : checkoutController.selectedDateSlot == 1 ? 'tomorrow'.tr : 'day_after_tomorrow'.tr} - ${checkoutController.preferableTime}' : 'instance'.tr),
                ),
      ...
      SizedBox(height: !isGuestLoggedIn && checkoutController.store!.scheduleOrder! && cartList != null && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Dimensions.paddingSizeSmall : 0),
