...
import 'package:suliman/features/checkout/widgets/prescription_view_dialog_widget.dart';
...
class PrescriptionImagePickerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return storeId == null && Get.find<SplashController>().configModel!.moduleConfig!.module!.orderAttachment! && isPrescriptionRequired ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
