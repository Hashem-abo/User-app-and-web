...
class ModuleStickyDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool get showLocationHeader => splashController.module?.showLocationHeader ?? false;
  String? get locationHeaderFontColor => splashController.module?.locationHeaderFontColor;
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    if (splashController.module != null && splashController.moduleList != null) {
      int selectedIndex = splashController.moduleList!.indexWhere((m) => m.id == splashController.module!.id || (m.moduleType != null && m.moduleType == splashController.module!.moduleType));
      if (selectedIndex > 0) {
        for (int i = 0; i < selectedIndex; i++) {
           ...
           collapsedInitialOffset += 115.0; // Approximation for collapsed chip width
        }
      }
    }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Positioned.fill(
            child: Opacity(
              opacity: 0.70, // ahmed: Increased visibility to 70% as requested
              child: ShaderMask(
                shaderCallback: (rect) {
                ...
                child: splashController.module?.skyHeaderFullUrl != null 
                  ...
                  : Image.asset(
                      ...
                      fit: BoxFit.cover,
                      errorBuilder: (c, e, s) => Container(color: Colors.blue.withValues(alpha: 0.1)),
                    ),
              ),
            ),
          ),
          ...
          Padding(
            padding: EdgeInsets.only(top: paddingTop), // ahmed: Apply top padding here
            child: Column(
            children: [
                        ...
                        child: ScrollControllerProvider(
                          ...
                          builder: (context, scrollController) {
                            return SizedBox(
                               ...
                               itemCount: splashController.moduleList?.length ?? 0,
                               itemBuilder: (context, index) {
                                 ...
                                 return InkWell(
                                   ...
                                   child: Builder(
                                     builder: (context) {
                                       double buttonWidth = splashController.moduleList![index].moduleButtonWidth ?? 65;
                                       double buttonHeight = splashController.moduleList![index].moduleButtonHeight ?? 65;
                                       String textPosition = splashController.moduleList![index].moduleViewTextPosition ?? 'bottom';
                                       
                                       Widget imageContainer = AnimatedScale(
                                         ...
                                         child: AnimatedContainer(
                                           ...
                                           decoration: BoxDecoration(
                                             shape: BoxShape.rectangle,
                                              borderRadius: splashController.moduleList![index].moduleButtonShape == 'square' ? BorderRadius.circular((splashController.moduleList![index].moduleButtonRadius ?? 15).toDouble()) : BorderRadius.circular(100),
                                              color: isSelected ? Theme.of(context).secondaryHeaderColor : Theme.of(context).primaryColor,
                                              boxShadow: isSelected ? [
                                               BoxShadow(color: Theme.of(context).secondaryHeaderColor.withOpacity(0.3), blurRadius: 8, spreadRadius: 2, offset: const Offset(0, 3))
                                             ] : null,
                                           ),
                                           child: ClipRRect(
                                             borderRadius: splashController.moduleList![index].moduleButtonShape == 'square' ? BorderRadius.circular((splashController.moduleList![index].moduleButtonRadius ?? 15).toDouble() - 2) : BorderRadius.circular(100),
                                             child: CustomImage(
                                       ...
                                       Widget textWidget = Container(
                                         padding: isSelected ? const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: 2) : null,
                                         decoration: isSelected ? BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(Dimensions.radiusSmall)) : null,
                                         child: Text(
                                           ...
                                           style: isSelected 
                                               ? robotoBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)
                                               : robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: splashController.moduleList![index].moduleButtonUnselectedColor != null ? Color(int.parse(splashController.moduleList![index].moduleButtonUnselectedColor!.replaceFirst('#', '0xff'))) : Colors.white),
                                         ),
                                       );
                            ...
                            builder: (context, scrollController) {
                              return SizedBox(
                                ...
                                child: ListView.builder(
                                  controller: scrollController,
                                  scrollDirection: Axis.horizontal,
                                  padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall, vertical: 10),
                                  physics: const BouncingScrollPhysics(),
                              itemCount: splashController.moduleList?.length ?? 0,
                              itemBuilder: (context, index) {
                                bool isSelected = splashController.module != null && 
              ...
              if (showLocationHeader)
                Container(
                  height: 50 * (1 - percent).clamp(0.0, 1.0), // Shrink height on collapse
                  width: Dimensions.webMaxWidth,
                  padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                  child: Opacity(
                    opacity: (1 - percent).clamp(0.0, 1.0), // Fade out on collapse
                    child: SingleChildScrollView( // Avoid overflow errors
                      physics: const NeverScrollableScrollPhysics(),
                      child: Center(
                        child: InkWell(
                          onTap: () => Get.find<LocationController>().navigateToLocationScreen('home'),
                          child: GetBuilder<LocationController>(builder: (locationController) {
                            Color? fontColor = locationHeaderFontColor != null ? Color(int.parse(locationHeaderFontColor!.replaceFirst('#', '0xff'))) : Theme.of(context).textTheme.bodyLarge!.color;
                            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Row(children: [
                                ...
                                Text(
                                  ...
                                  style: robotoBold.copyWith(color: fontColor, fontSize: Dimensions.fontSizeLarge),
                              ...
                              Row(children: [
                                Flexible(
                                  child: Text(
                                    ...
                                    style: robotoRegular.copyWith(color: fontColor, fontSize: Dimensions.fontSizeDefault),
                                    maxLines: 1, overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                                Icon(Icons.expand_more, color: fontColor, size: 20),
                              ]),
                            ]);
                          }),
                        ),
  ...
  double get maxExtent {
    return expandedHeight + (searchBar != null ? searchBarHeight : 0) + (showLocationHeader ? 50 : 0) + paddingTop;
  }

  @override
  double get minExtent => collapsedHeight + (searchBar != null ? searchBarHeight : 0) + paddingTop;
  ...
  bool shouldRebuild(ModuleStickyDelegate oldDelegate) {
    return oldDelegate.searchBar != searchBar || 
           ...
           oldDelegate.showLocationHeader != showLocationHeader || // Check if module type changed
...
class ScrollControllerProvider extends StatefulWidget {
  ...
  const ScrollControllerProvider({Key? key, required this.initialScrollOffset, required this.builder}) : super(key: key);
