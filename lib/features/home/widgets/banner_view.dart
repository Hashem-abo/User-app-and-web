...
class BannerView extends StatelessWidget {
  ...
  final double? height;
  const BannerView({super.key, required this.isFeatured, this.height});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BannerController>(builder: (bannerController) {
      ...
      return (bannerList != null && bannerList.isEmpty) ? const SizedBox() : Container(
        ...
        height: height ?? (GetPlatform.isDesktop ? 500 : MediaQuery.of(context).size.width * 0.429), // 1400x600 ratio
        padding: EdgeInsets.zero, // ahmed: Remove top padding
            ...
            Positioned.fill(
              child: CarouselSlider.builder(
                ...
                itemBuilder: (context, index, _) {
                  bool isSelected = bannerController.currentIndex == index;
                  return InkWell(
                    onTap: () async {
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                        child: AnimatedScale( // ahmed: Image Zoom Effect
