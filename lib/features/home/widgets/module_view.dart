...
import 'package:suliman/features/home/widgets/popular_store_view.dart';
...
class ModuleView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const Center(child: Text('DEBUG: ModuleView Loaded', style: TextStyle(color: Colors.red, fontSize: 24, fontWeight: FontWeight.bold))), // + ahmed debug
      ...
      splashController.moduleList != null ? splashController.moduleList!.isNotEmpty ? GridView.builder(
        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
          ...
          crossAxisSpacing: Dimensions.paddingSizeSmall, childAspectRatio: (1/1.1),
        ),
        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () {
                  print('Module Clicked: Index: $index, Name: ${splashController.moduleList![index].moduleName}');
                  splashController.switchModule(index, true);
                },
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                child: Padding(
                  padding: const EdgeInsets.all(Dimensions.paddingSizeSmall), // Add padding here for click area
