...
import 'package:suliman/common/widgets/hover/on_hover.dart';
import 'package:suliman/common/widgets/organic_tag.dart';

class MedicineItemCard extends StatelessWidget {
  final Item item;
  final double? width;
  const MedicineItemCard({super.key, required this.item, this.width});
  ...
  Widget build(BuildContext context) {
    ...
    return OnHover(
      isItem: true,
      child: Container(
        width: width ?? (ResponsiveHelper.isDesktop(context) ? 230 : isShop ? 200 : 180),
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center, alignment: isShop ? WrapAlignment.center : WrapAlignment.start, children: [
                        ...
                        Text(
                          ...
                          textDirection: TextDirection.rtl, style: robotoBold.copyWith(color: Theme.of(context).primaryColor),
                        ),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
