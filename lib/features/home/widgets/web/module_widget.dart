                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: (splashController.module != null && (splashController.moduleList![index].id == splashController.module!.id || (splashController.moduleList![index].moduleType == splashController.module!.moduleType)))
                            ? Theme.of(context).primaryColor.withValues(alpha: 0.2) : Theme.of(context).disabledColor.withValues(alpha: 0.2),
                        border: (splashController.module != null && (splashController.moduleList![index].id == splashController.module!.id || (splashController.moduleList![index].moduleType == splashController.module!.moduleType)))
