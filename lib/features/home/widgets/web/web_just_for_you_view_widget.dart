...
class WebJustForYouViewWidget extends StatefulWidget {
  final double? height;
  const WebJustForYouViewWidget({super.key, this.height});
    ...
    return GetBuilder<CampaignController>(builder: (campaignController) {
      ...
      return campaignController.itemCampaignList != null ? campaignController.itemCampaignList!.isNotEmpty ? Stack(children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(
            height: widget.height ?? 185, width: Get.width,
                    ...
                    builder: (hovered) {
                      return OnHover(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            height: widget.height ?? 185, width: widget.height ?? 185,
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImage(
                                ...
                                fit: BoxFit.cover, height: widget.height ?? 185, width: widget.height ?? 185,
                              ),
                            ),
                          ),
                        ),
