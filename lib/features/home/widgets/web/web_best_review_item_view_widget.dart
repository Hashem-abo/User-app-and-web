...
import 'package:suliman/features/home/widgets/components/review_item_card_widget.dart';
...
class WebBestReviewItemViewWidget extends StatefulWidget {
  final double? height;
  const WebBestReviewItemViewWidget({super.key, this.height});
      ...
      return reviewItemList != null ? reviewItemList.isNotEmpty ? Stack(children: [
        Container(
          ...
          child: Column(children: [
            ...
            SizedBox(
              height: widget.height ?? 285, width: Get.width,
