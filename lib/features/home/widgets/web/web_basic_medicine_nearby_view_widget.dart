...
class WebBasicMedicineNearbyViewWidget extends StatefulWidget {
  final double? height;
  const WebBasicMedicineNearbyViewWidget({super.key, this.height});
...
class _WebBasicMedicineNearbyViewWidgetState extends State<WebBasicMedicineNearbyViewWidget> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      ...
      bool hasData = itemController.basicMedicineModel != null;
      ...
      return hasData ? Column(children: [
        ...
        Stack(children: [
          Container(
            ...
            child: SizedBox(
              height: widget.height ?? 280, width: Get.width,
