...
class HighlightWidget extends StatefulWidget {
  final String? title;
  const HighlightWidget({super.key, this.title});
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(widget.title ?? 'highlights_for_you'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.black)),
