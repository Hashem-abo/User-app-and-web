    ...
    return OnHover(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: ResponsiveHelper.isMobile(context) ? [BoxShadow(color: Theme.of(context).primaryColor.withValues(alpha: 0.1), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))] : null,
        ),
        child: CustomInkWell(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Wrap(alignment: WrapAlignment.center, crossAxisAlignment: WrapCrossAlignment.center, children: [
                        ...
                        Text(
                          ...
                          textDirection: TextDirection.ltr, style: robotoBlack.copyWith(fontSize: Dimensions.fontSizeLarge),
                        ),
                      ]),
                    ]),
                  ),
