...
class ReviewItemCard extends StatelessWidget {
  ...
  final Item? item;
  final double? width;
  const ReviewItemCard({super.key, this.isFeatured = false, this.item, this.width});
                    ...
                    child: Column(
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center, alignment: WrapAlignment.start, children: [
                        ...
                        Text(
                          ...
                          style: robotoBold.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.rtl,
                        ),
                      ]),
