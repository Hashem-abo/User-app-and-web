  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<BannerController>(builder: (bannerController) {
      ...
      return (bannerList != null && bannerList.isEmpty) ? const SizedBox() : Container(
        ...
        height: GetPlatform.isDesktop ? 400 : MediaQuery.of(context).size.width * 0.429, // 1400x600 ratio (600/1400 = 0.429)
            ...
            Positioned.fill(
              child: CarouselSlider.builder(
                options: CarouselOptions(
                  ...
                  disableCenter: false,
                  viewportFraction: 1.0, // ahmed: Full width, no side cards
