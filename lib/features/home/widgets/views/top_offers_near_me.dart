...
class TopOffersNearMe extends StatefulWidget {
  final String? title;
  const TopOffersNearMe({super.key, this.title});

  @override
  State<TopOffersNearMe> createState() => _TopOffersNearMeState();
}

class _TopOffersNearMeState extends State<TopOffersNearMe> {
  @override
  void initState() {
    super.initState();
    var storeController = Get.find<StoreController>();
    if (storeController.topOfferStoreList == null) {
      storeController.getTopOfferStoreList(false, false);
    }
  }
      ...
      return storeList != null ? storeList.isNotEmpty ? Container(
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: TitleWidget(
              title: widget.title ?? 'top_offers_near_me'.tr,
