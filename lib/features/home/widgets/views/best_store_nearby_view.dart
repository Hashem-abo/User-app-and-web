        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            (isPharmacy || isFood) ? Padding(
              ...
              child: TitleWidget(
                title: isPharmacy ? 'featured_store'.tr : (isFood ? (Get.find<LocalizationController>().isLtr ? 'Best Restaurants Nearby' : 'أفضل المطاعم القريبة') : 'best_store_nearby'.tr),
                ...
                child: Row(children: [
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'see_all'.tr,
                        style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor, decoration: TextDecoration.underline, decorationColor: Theme.of(context).primaryColor, decorationThickness: 1.5),
                      ),
                    ),
                  ),
