...
class AllStoreScreen extends StatefulWidget {
  ...
  const AllStoreScreen({super.key, required this.isPopular, required this.isFeatured, required this.isNearbyStore, required this.isTopOfferStore, required this.isRecommendedStore, this.backButton = true});
                      ...
                      return ItemsView(
                        ...
                        stores: () {
                          ...
                          if (widget.isNearbyStore && rawList != null) {
                            ...
                            sorted.sort((a, b) {
                              double distA = a.distance ?? double.maxFinite;
                              double distB = b.distance ?? double.maxFinite;
                              // Raw values > 100 are in meters, normalise to km
                              if (distA > 100) distA = distA / 1000;
                              if (distB > 100) distB = distB / 1000;
