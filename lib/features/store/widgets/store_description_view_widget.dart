    ...
    return Column(children: [
     ...
     IntrinsicHeight(
       child: Row(children: [
         ...
         InkWell(
           onTap: () => Get.toNamed(RouteHelper.getReviewRoute(store!.id.toString(), storeName: store!.name, store: store!)),
         ...
         Column(children: [
           ...
           Text(store!.deliveryTime!.replaceAll('min', 'min'.tr).replaceAll('mins', 'mins'.tr), style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
         ]),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  Text('rate'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  Text('location'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
          ...
          Expanded(
            child: Container(
              ...
              child: Column(children: [
                ...
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                Text('delivery_time'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                Text(store!.deliveryTime!.replaceAll('min', 'min'.tr).replaceAll('mins', 'mins'.tr), style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
              ]),
            ),
          ),
        ]),
