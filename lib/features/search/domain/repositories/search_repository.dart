...
class SearchRepository implements SearchRepositoryInterface {
  ...
  Future<Response> _getSearchData(String? query, bool isStore) async {
    return await apiClient.getData('${AppConstants.searchUri}${isStore ? 'stores' : 'items'}/search?name=$query&offset=1&limit=12');
  }

  @override
  Future<Response> getSearchByAiData(String? query) async {
    return await apiClient.getData('${AppConstants.searchByAiUri}?name=$query&offset=1&limit=12');
  }
