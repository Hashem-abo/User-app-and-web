...
class VoiceSearchBottomSheet extends StatefulWidget {
  ...
  final bool isAi;
  const VoiceSearchBottomSheet({super.key, required this.searchTextEditingController, this.isAi = false});
...
class _VoiceSearchBottomSheetState extends State<VoiceSearchBottomSheet> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _searchController.setAiVoice(widget.isAi, isUpdate: false);
      ...
      return Container(
        ...
        child: Stack(children: [
          SingleChildScrollView(
            ...
            Text(
              widget.isAi ? 'ai_voice_search'.tr : 'voice_search'.tr,
