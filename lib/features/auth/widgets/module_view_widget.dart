...
class ModuleViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<StoreRegistrationController>(builder: (storeRegController) {
      ...
      if(storeRegController.filteredModuleList != null && storeRegController.filteredModuleList!.isNotEmpty) {
        for(var module in storeRegController.filteredModuleList!) {
          int index = storeRegController.moduleList!.indexOf(module);
