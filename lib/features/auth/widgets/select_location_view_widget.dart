...
import 'package:suliman/features/auth/widgets/pickup_zone_widget.dart';
import 'package:suliman/features/auth/widgets/zone_selection_widget.dart';
...
import 'package:suliman/features/location/widgets/location_search_dialog_widget.dart';
...
class _SelectLocationViewWidgetState extends State<SelectLocationViewWidget> {
  ...
  void _setPolygon(ZoneDataModel zoneModel) {
    ...
    Future.delayed( const Duration(milliseconds: 500),(){
      LatLngBounds bounds = boundsFromLatLngList(zoneLatLongList);
      LatLng center = LatLng(
        (bounds.northeast.latitude + bounds.southwest.latitude) / 2,
        (bounds.northeast.longitude + bounds.southwest.longitude) / 2,
      );

      _mapController?.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: center, zoom: 17)));
    });
