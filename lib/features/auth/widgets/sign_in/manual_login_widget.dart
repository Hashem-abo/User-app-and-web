...
import 'package:suliman/features/auth/widgets/sign_up_widget.dart';
    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(
        ...
        children: [
          ...
          Directionality(
            textDirection: authController.isNumberLogin ? TextDirection.ltr : Directionality.of(context),
            child: CustomTextField(
              ...
              // Switches to numeric keypad when number mode is detected
              inputType: authController.isNumberLogin ? TextInputType.number : TextInputType.emailAddress,
              maxLength: authController.isNumberLogin ? 9 : null,
              prefixIcon: authController.isNumberLogin ? Icons.phone_outlined : Icons.email_outlined,
              ...
              validator: (String? value) {
                ...
                return (GetUtils.isPhoneNumber(authController.countryDialCode + value!.tr) || GetUtils.isEmail(value.tr))
                    ? null
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Text('create_new_account'.tr, style: robotoBold.copyWith(color: Theme.of(context).primaryColor)),
              ),
            ),
          ]),
        ],
          ...
          child: Column(children: [
            ...
            Directionality(
              ...
              child: CustomTextField(
                ...
                // Numeric input type when dialing/typing a phone number
                inputType: authController.isNumberLogin ? TextInputType.number : TextInputType.emailAddress,
                maxLength: authController.isNumberLogin ? 9 : null,
                onChanged: (String text) {
                  final numberRegExp = RegExp(r'^[+]?[0-9]+$');
                ...
                validator: (String? value) {
                  ...
                  return (GetUtils.isPhoneNumber(value!.tr) || GetUtils.isEmail(value.tr))
                      ? null
                      : 'enter_email_address_or_phone_number'.tr;
                },
              ),
