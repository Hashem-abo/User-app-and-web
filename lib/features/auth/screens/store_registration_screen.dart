...
import 'package:suliman/features/auth/widgets/business/base_card_widget.dart';
import 'package:suliman/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:suliman/features/auth/widgets/module_view_widget.dart';
import 'package:suliman/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:suliman/features/business/widgets/package_card_widget.dart';
...
import 'package:suliman/common/models/translation.dart';
...
import 'package:suliman/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:suliman/features/auth/widgets/pass_view_widget.dart';
import 'package:suliman/features/auth/widgets/select_location_view_widget.dart';
    ...
    return Column(children: [
      ...
      storeRegController.storeStatus != 0.9 ? Column(children: [
        ...
        Row(children: [
          ...
          Text(storeRegController.registrationType == RegistrationType.serviceProvider ? 'provider_information'.tr : 'vendor_information'.tr, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        child: storeRegController.pickedLogo != null ? GetPlatform.isWeb ? Image.network(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                '${storeRegController.registrationType == RegistrationType.serviceProvider ? 'upload_provider_logo'.tr : 'upload_vendor_logo'.tr} (${'1:1'})',
                      ...
                      child: ClipRRect(
                        ...
                        child: storeRegController.pickedCover != null ? GetPlatform.isWeb ? Image.network(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text(
                              '${storeRegController.registrationType == RegistrationType.serviceProvider ? 'upload_provider_cover'.tr : 'upload_vendor_cover'.tr} (${'3:1'})',
