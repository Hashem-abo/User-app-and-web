...
class StoreRegistrationController extends GetxController implements GetxService {
  ...
  List<ModuleModel>? get filteredModuleList {
    if (_moduleList == null) return null;
    return _moduleList!.where((module) {
      if (_registrationType == RegistrationType.serviceProvider) {
        return module.moduleType == 'services';
      } else {
        return module.moduleType != 'services' && module.moduleType != 'parcel';
      }
    }).toList();
  }
  ...
  Future<void> pickFiles() async {
    ...
    if(GetPlatform.isWeb){
      ...
      result = await FilePicker.platform.pickFiles(
        ...
        allowedExtensions: ['pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png', 'avif'],
        allowMultiple: false,
      );
    }
