...
class AuthRepository implements AuthRepositoryInterface{
  ...
  Future<bool> saveProductRefCode(String code) async {
    return await sharedPreferences.setString(AppConstants.productReferralCode, code);
  }

  @override
  String getProductRefCode() {
    return sharedPreferences.getString(AppConstants.productReferralCode) ?? "";
  }

  @override
  Future<bool> clearProductRefCode() async {
    return await sharedPreferences.remove(AppConstants.productReferralCode);
  }
