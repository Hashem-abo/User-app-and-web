...
abstract class AuthServiceInterface{
  ...
  Future<ResponseModel> updatePersonalInfo({required String name, required String? phone, required String loginType, required String? email, required String? referCode, required String? gender, bool alreadyInApp = false});
  ...
  Future<bool> saveProductRefCode(String code);
  String getProductRefCode();
  Future<bool> clearProductRefCode();
}