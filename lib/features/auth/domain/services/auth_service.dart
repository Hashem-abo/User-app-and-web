...
import 'package:suliman/features/auth/domain/models/auth_response_model.dart';
...
class AuthService implements AuthServiceInterface{
  ...
  Future<bool> saveProductRefCode(String code) async {
    return await authRepositoryInterface.saveProductRefCode(code);
  }

  @override
  String getProductRefCode() {
    return authRepositoryInterface.getProductRefCode();
  }

  @override
  Future<bool> clearProductRefCode() async {
    return await authRepositoryInterface.clearProductRefCode();
  }
