...
import 'package:suliman/features/address/widgets/address_confirmation_dialogue.dart';
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            ) : NoDataScreen(text: 'no_saved_address_found'.tr, fromAddress: true) : const CustomLoaderWidget(),
                          ],
                        ),
                      ),
                    ))
