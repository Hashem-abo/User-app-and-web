...
class Item {
  ...
  Item.fromJson(Map<String, dynamic> json) {
    ...
    categoryId = (json['category_id'] != null && json['category_id'].toString().trim().isNotEmpty) ? int.tryParse(json['category_id'].toString()) : null;
    if (json['category_ids'] != null) {
      categoryIds = [];
      dynamic categoryIdsData = json['category_ids'];
      if(categoryIdsData is String) {
        categoryIdsData = jsonDecode(categoryIdsData);
      }
      if(categoryIdsData is List) {
        for (var v in categoryIdsData) {
    ...
    if (json['food_variations'] != null) {
      ...
      if(foodVariationsData is List && foodVariationsData.isNotEmpty) {
    ...
    wishlistCount = json['whislists_count'] ?? json['wishlist_count'];
    itemViewCount = json['views_count'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['store_category_name'] = storeCategoryName;
    data['slug'] = slug;
...
class CategoryIds {
  ...
  CategoryIds.fromJson(Map<String, dynamic> json) {
    id = (json['id'] != null && json['id'].toString().trim().isNotEmpty) ? int.tryParse(json['id'].toString()) : null;
    position = (json['position'] != null && json['position'].toString().trim().isNotEmpty) ? int.tryParse(json['position'].toString()) : null;
  }
...
class Variation {
  ...
  Variation({this.type, this.price, this.stock, this.imagesFullUrl});
