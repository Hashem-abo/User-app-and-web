...
class ItemService implements ItemServiceInterface {
  ...
  @override
  Future<ItemModel?> getPopularItemList({required String type, DataSourceEnum? source, required int offset, String? search, List<int>? categoryIds, List<String>? filter, int? rating, double? minPrice, double? maxPrice, int? moduleId}) async { // + ahmed
    return await itemRepositoryInterface.getList(isPopularItem: true,  type: type, source: source, offset: offset, search: search, categoryIds: categoryIds, filter: filter, rating: rating, minPrice: minPrice, maxPrice: maxPrice, moduleId: moduleId); // + ahmed
  }

  @override
  Future<ItemModel?> getReviewedItemList({required String type, DataSourceEnum? source, required int offset, String? search, List<int>? categoryIds, List<String>? filter, int? rating, double? minPrice, double? maxPrice, int? moduleId}) async {
    return await itemRepositoryInterface.getList(isReviewedItem: true,  type: type, source: source, offset: offset, search: search, categoryIds: categoryIds, filter: filter, rating: rating, minPrice: minPrice, maxPrice: maxPrice, moduleId: moduleId);
  }
  ...
  @override
  Future<ItemModel?> getPaginatedRecommendedItemList({required String type, DataSourceEnum? source, required int offset, String? search, List<int>? categoryIds, List<String>? filter, int? rating, double? minPrice, double? maxPrice, int? moduleId}) async {
    return await itemRepositoryInterface.getList(isPaginatedRecommendedItems: true, type: type, source: source, offset: offset, search: search, categoryIds: categoryIds, filter: filter, rating: rating, minPrice: minPrice, maxPrice: maxPrice, moduleId: moduleId);
  }

  @override
  Future<ItemModel?> getLatestItemList({required String type, DataSourceEnum? source, required int offset, String? search, List<int>? categoryIds, List<String>? filter, int? rating, double? minPrice, double? maxPrice, int? moduleId}) async {
    return await itemRepositoryInterface.getList(isLatestItem: true, type: type, source: source, offset: offset, search: search, categoryIds: categoryIds, filter: filter, rating: rating, minPrice: minPrice, maxPrice: maxPrice, moduleId: moduleId);
  }

  @override
  Future<ItemModel?> getDiscountedItemList({required String type, DataSourceEnum? source, required int offset, String? search, List<int>? categoryIds, List<String>? filter, int? rating, double? minPrice, double? maxPrice, int? moduleId}) async {
    return await itemRepositoryInterface.getList(isDiscountedItems: true, type: type, source: source, offset: offset, search: search, categoryIds: categoryIds, filter: filter, rating: rating, minPrice: minPrice, maxPrice: maxPrice, moduleId: moduleId);
  }

  @override
  Future<ItemModel?> getBuyAgainItemList() async {
    return await itemRepositoryInterface.getBuyAgainItemList();
  }
  ...
  List<List<bool?>> initializeSelectedVariation(List<FoodVariation>? foodVariations) {
    ...
    if (foodVariations != null) {
      for(int index=0; index<foodVariations.length; index++) {
        ...
        bool isRequired = foodVariations[index].required ?? false;
        int min = foodVariations[index].min ?? 0;
        
        for(int i=0; i < (foodVariations[index].variationValues?.length ?? 0); i++) {
          // Auto-select if required or minimum requires selection
          if (i == 0 && (isRequired || min > 0)) {
            selectedVariations[index].add(true);
          } else {
  ...
  Future<void> recordItemView(int itemID) async {
    await itemRepositoryInterface.recordItemView(itemID);
  }

  @override
  Future<ResponseModel> likeReview(int reviewID) async {
    return await itemRepositoryInterface.likeReview(reviewID);
  }

  @override
  Future<ResponseModel> unlikeReview(int reviewID) async {
    return await itemRepositoryInterface.unlikeReview(reviewID);
  }
}