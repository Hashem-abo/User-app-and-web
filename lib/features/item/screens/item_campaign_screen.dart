...
class ItemCampaignScreen extends StatefulWidget {
  ...
  const ItemCampaignScreen({super.key, required this.isJustForYou, this.backButton = true});
...
class _ItemCampaignScreenState extends State<ItemCampaignScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.isJustForYou ? 'just_for_you'.tr : 'campaigns'.tr, backButton: widget.backButton),
