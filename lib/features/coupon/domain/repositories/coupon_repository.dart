...
class CouponRepository implements CouponRepositoryInterface {
  ...
  Future<List<CouponModel>?> _getCouponList() async {
    ...
    Response response = await apiClient.getData(AppConstants.couponUri, handleError: false);
  ...
  Future<List<CouponModel>?> _getTaxiCouponList() async {
    ...
    Response response = await apiClient.getData(AppConstants.taxiCouponUri, handleError: false);
    if (response.statusCode == 200) {
      taxiCouponList = [];
