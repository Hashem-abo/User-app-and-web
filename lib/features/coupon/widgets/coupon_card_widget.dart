          ...
          child: Row(children: [
            ...
            Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text(
                  '${(coupon.discountType == 'percent' || Get.find<SplashController>().configModel!.currencySymbolDirection == 'right') ? '' : Get.find<SplashController>().configModel!.currencySymbol}'
                      '${coupon.discount}${coupon.discountType == 'percent' ? '%' : (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '')} ${'off'.tr}',
