  ...
  void initState() {
    ...
    if(!Get.isRegistered<ReelsController>()) {
      Get.lazyPut<ReelsController>(() => ReelsController(
        reelsServiceInterface: Get.find<ReelsServiceInterface>(),
      ));
    }
    ReelsController reelsController = Get.find<ReelsController>();
    if(reelsController.reelsList == null) {
      reelsController.getReelsList(offset: 1);
    }
  }
            ...
            children: <Widget>[
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    CustomAssetImageWidget(Images.reelTitleIcon, height: 24, width: 24),
