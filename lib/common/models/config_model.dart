...
class ConfigModel {
  ...
  String? appUrlIos;
  double? appLatestVersionAndroid;
  double? appLatestVersionIos;
  ...
  int? batchedMaxStores;
  List<OnboardingScreen>? onboardingScreens;
  String? openAiSystemPrompt;
  int? aiGuestQuestionLimit;
  int? aiUserQuestionLimit;
  int? aiAccountAdviceLimit;
  int? aiSearchImageLimit;
  int? aiVoiceExtractLimit;
  ...
  ConfigModel({
    ...
    this.batchedMaxStores,
    this.onboardingScreens,
    this.openAiSystemPrompt,
    this.aiGuestQuestionLimit,
    this.aiUserQuestionLimit,
    this.aiAccountAdviceLimit,
    this.aiSearchImageLimit,
    this.aiVoiceExtractLimit,
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    // if(currencySymbol?.trim() == 'ريال' || currencySymbol?.trim() == 'YER') {
    //   currencySymbol = 'ر.ي';
    // }
    ...
    appLatestVersionAndroid = json['app_latest_version_android']?.toDouble() ?? 0.0;
    appLatestVersionIos = json['app_latest_version_ios']?.toDouble() ?? 0.0;
    ...
    batchedMaxStores = json['batched_max_stores'] != null ? int.tryParse(json['batched_max_stores'].toString()) : 1;
    openAiSystemPrompt = json['openai_system_prompt'];
    aiGuestQuestionLimit = json['ai_guest_question_limit'] != null ? int.tryParse(json['ai_guest_question_limit'].toString()) : null;
    aiUserQuestionLimit = json['ai_user_question_limit'] != null ? int.tryParse(json['ai_user_question_limit'].toString()) : null;
    aiAccountAdviceLimit = json['ai_account_advice_limit'] != null ? int.tryParse(json['ai_account_advice_limit'].toString()) : null;
    aiSearchImageLimit = json['ai_search_image_limit'] != null ? int.tryParse(json['ai_search_image_limit'].toString()) : null;
    aiVoiceExtractLimit = json['ai_voice_extract_limit'] != null ? int.tryParse(json['ai_voice_extract_limit'].toString()) : null;
    ...
    if (json['onboarding_screens'] != null) {
      ...
      json['onboarding_screens'].forEach((v) {
        onboardingScreens!.add(OnboardingScreen.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['app_latest_version_android'] = appLatestVersionAndroid;
    data['app_latest_version_ios'] = appLatestVersionIos;
    ...
    data['virtual_try_on_loyalty_point_cost'] = virtualTryOnLoyaltyPointCost;
    data['homepage_cache_version'] = homepageCacheVersion;
