...
import 'package:suliman/common/widgets/quantity_button.dart';
...
class _ItemBottomSheetState extends State<ItemBottomSheet> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      itemController.getItemDetails(itemId: widget.itemId, cart: widget.cart, item: widget.item, isCampaign: widget.isCampaign, fetchSimilarItems: false).then((_) {
        if(mounted) {
          setState(() {
          ...
          child: Stack(
            children: [
              Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                              ...
                              (item.isStoreHalalActive ?? false) && (item.isHalalItem ?? false) ? Padding(
                ...
                ///Bottom side..
                (!(item.scheduleOrder ?? false) && !isAvailable) ? const SizedBox() : Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                            ...
                            onPressed: (stock != null && stock <= 0) ? null : () async {
                              ...
                              if(invalid != null) {
                                ...
                                CartModel cartModel = CartModel(
                                    ...
                                    quantity: itemController.quantity, addOnIds: addOnIdList, addOns: addOnsList, isCampaign: widget.isCampaign, stock: stock, item: item,  quantityLimit: item.quantityLimit
                                );
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Wrap(
            ...
            children: List.generate(item!.choiceOptions![index].options!.length, (i) {
              bool isSelected = itemController.variationIndex![index] == i;
              return InkWell(
                onTap: () {
