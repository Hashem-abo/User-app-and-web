...
class AddFavouriteView extends StatefulWidget {
  ...
  final bool isCorner;
  final Color? color;
  const AddFavouriteView({super.key, required this.item, this.top = 15, this.right = 15, this.left, this.storeId, this.isBackgroundColor = false, this.isCorner = false, this.color});
      ...
      child: GetBuilder<FavouriteController>(builder: (favouriteController) {
        ...
        return InkWell(
          ...
          child: ScaleTransition(
            ...
            child: widget.isCorner ? Container(
              ...
              child: Icon(isWished ? CupertinoIcons.heart_solid : CupertinoIcons.heart, color: Colors.white, size: 18),
            ) : widget.isBackgroundColor ? Container(
              ...
              child: Icon(isWished ? CupertinoIcons.heart_solid : CupertinoIcons.heart, color: Colors.white, size: 18),
            ) : Icon(isWished ? CupertinoIcons.heart_solid : CupertinoIcons.heart, color: isWished ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withValues(alpha: 0.3), size: 25),
          ),
        );
      }),
    );
