                  ...
                  Stack(
                    children: [
                      CustomImage(
                        ...
                        fit: BoxFit.cover, width: double.infinity, height: 125, // Cover Height
                      ),
                              ...
                              Expanded(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text((store.avgRating ?? 0.0).toStringAsFixed(1), style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    const SizedBox(width: 2),
                                    Flexible(child: Text('(${store.ratingCount ?? 0})', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor), overflow: TextOverflow.ellipsis)),
                                  ],
                                ),
                              ),
                            ],
