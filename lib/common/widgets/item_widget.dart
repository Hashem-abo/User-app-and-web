...
import 'package:suliman/common/widgets/corner_banner/banner.dart';
import 'package:suliman/common/widgets/corner_banner/corner_discount_tag.dart';
import 'package:suliman/common/widgets/custom_asset_image_widget.dart';
import 'package:suliman/common/widgets/custom_favourite_widget.dart';
...
import 'package:suliman/common/widgets/not_available_widget.dart';
                    ...
                    child: Row(children: [
                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          inStore ? const SizedBox() : (isStore ? store!.address != null : item!.storeName != null) ? Row(
                            children: [
                              if (!isStore) ...[
                                StoreVerifiedAvatar(
                                  imageUrl: item?.storeLogoFullUrl ?? (item?.storeDetails != null ? item?.storeDetails!['logo_full_url'] : null),
                                  isVerified: (item?.verifiedSeller == 1) || (item?.storeDetails?['verified_seller'] == 1) || (item?.storeDetails?['verified_seller'] == '1') || (item?.storeDetails?['verified_seller'] == true),
                                  size: 14,
                                ),
