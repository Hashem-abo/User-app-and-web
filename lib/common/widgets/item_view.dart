...
import 'package:suliman/features/home/widgets/web/widgets/store_card_widget.dart';
import 'package:suliman/helper/responsive_helper.dart';
import 'package:suliman/util/dimensions.dart';
import 'package:suliman/common/widgets/no_data_screen.dart';
import 'package:suliman/common/widgets/item_shimmer.dart';
import 'package:suliman/common/widgets/item_widget.dart';
...
class ItemsView extends StatefulWidget {
  ...
  final int? mobileItemCrossAxisCount; // + ahmed
  const ItemsView({super.key, required this.stores, required this.items, required this.isStore, this.isScrollable = false,
    ...
    this.isFoodOrGrocery = true, this.mobileItemCrossAxisCount}); // + ahmed
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        ...
        itemBuilder: (context, index) {
          return widget.stores != null && widget.isStore ?  StoreCardWithDistance(
            store: widget.stores![index]!, 
            fromAllStore: true,
            isNewStore: false, // Pass isNewStore if needed, or rely on internal logic
          )
        ...
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          ...
          mainAxisExtent: ResponsiveHelper.isDesktop(context) && widget.isStore ? 220 : ResponsiveHelper.isMobile(context) ? widget.isStore ? 250 : 110 : 110,
