...
import 'package:suliman/common/widgets/corner_banner/positioned_banner.dart';
        ...
        child: Row(
          ...
          children: [
            Column(
              ...
              children:  [
                Text(
                  discount! > 0 ? '${(discountType == 'percent' || Get.find<SplashController>().configModel!.currencySymbolDirection == 'right') ? '' : Get.find<SplashController>().configModel!.currencySymbol}'
                      '$discount${discountType == 'percent' ? '%' : (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '')} ${'off'.tr}'
                      : 'free_delivery'.tr,
