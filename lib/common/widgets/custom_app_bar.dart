...
import 'package:suliman/common/widgets/cart_widget.dart';
...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppBar({super.key, required this.title, this.backButton = true, this.onBackPressed, this.showCart = false, this.leadingIcon, this.onVegFilterTap, this.type, this.menuWidget, this.actionWidget, this.titleWidget, this.backgroundColor});
  ...
  Widget build(BuildContext context) {
    return ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(
      ...
      actions: showCart || onVegFilterTap != null ? [
        ...
        actionWidget ?? (menuWidget ?? const SizedBox()),
      ],
    );
  }
