...
import 'package:suliman/features/search/widgets/voice_search_bottom_sheet.dart';
...
class VoicePermissionHandler {
  ...
  static Future<void> openVoiceSearch({required BuildContext context, required TextEditingController searchTextEditingController, required bool isDesktop, bool isAi = false}) async {
