...
class NotificationHelper {
      ...
      try{
        if(load.payload!.isNotEmpty) {
          ...
          final Map<NotificationType, Function> notificationActions = {
            ...
            NotificationType.question_reply: () => Get.toNamed(RouteHelper.getMyQuestionsRoute()),
            NotificationType.service_booking: () => Get.toNamed(RouteHelper.getServiceBookingTrackingRoute(id: payload.orderId!)),
          };
      ...
      try{
        if(message.data.isNotEmpty) {
          ...
          final Map<NotificationType, Function> notificationActions = {
            ...
            NotificationType.question_reply: () => Get.toNamed(RouteHelper.getMyQuestionsRoute()),
            NotificationType.service_booking: () => Get.toNamed(RouteHelper.getServiceBookingTrackingRoute(id: int.parse(message.data['order_id'] ?? message.data['booking_id']))),
          };
  ...
  static NotificationBodyModel convertNotification(Map<String, dynamic> data) {
    ...
    switch (type) {
      ...
      case 'question_reply':
        return NotificationBodyModel(notificationType: NotificationType.question_reply);
      case 'service_booking':
        return NotificationBodyModel(
          orderId: int.tryParse(data['booking_id'].toString()) ?? int.tryParse(data['order_id'].toString()) ?? 0,
          notificationType: NotificationType.service_booking,
        );
      default:
        return NotificationBodyModel(notificationType: NotificationType.general);
    }
