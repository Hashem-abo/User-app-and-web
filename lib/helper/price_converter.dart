...
class PriceConverter {
  ...
  static String percentageCalculation(String price, String discount, String discountType) {
    return '${(discountType == 'percent' || Get.find<SplashController>().configModel!.currencySymbolDirection == 'right') ? '' : Get.find<SplashController>().configModel!.currencySymbol}'
        '$discount'
        '${discountType == 'percent' ? '%' : (Get.find<SplashController>().configModel!.currencySymbolDirection == 'right' ? Get.find<SplashController>().configModel!.currencySymbol : '')}'
        ' OFF';
  }
  ...
  static int get noTipIndex => AppConstants.tips.indexOf('0');
}