...
import 'package:suliman/features/brands/screens/brands_product_screen.dart';
import 'package:suliman/features/brands/screens/brands_screen.dart';
import 'package:suliman/features/forum/screens/forum_screen.dart';
import 'package:suliman/features/forum/screens/forum_details_screen.dart';
import 'package:suliman/features/forum/domain/models/forum_post_model.dart';
import 'package:suliman/features/business/screens/subscription_payment_screen.dart';
import 'package:suliman/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:suliman/features/chat/domain/models/order_chat_model.dart';
import 'package:suliman/features/item/screens/item_view_all_screen.dart';
import 'package:suliman/features/loyalty/screens/loyalty_screen.dart';
import 'package:suliman/features/profile/domain/models/update_user_model.dart';
import 'package:suliman/features/profile/screens/setting_page.dart';
import 'package:suliman/features/refer_and_earn/screens/refer_and_earn_screen.dart';
...
import 'package:suliman/features/order/screens/my_items_screen.dart';
import 'package:suliman/features/order/screens/my_items_detail_screen.dart';
...
import 'package:suliman/features/address/screens/add_address_screen.dart';
import 'package:suliman/features/address/screens/address_screen.dart';
import 'package:suliman/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:suliman/features/auth/screens/sign_in_screen.dart';
import 'package:suliman/features/auth/screens/sign_up_screen.dart';
import 'package:suliman/features/auth/screens/store_registration_screen.dart';
import 'package:suliman/features/category/screens/category_screen.dart';
import 'package:suliman/features/location/screens/map_screen.dart';
import 'package:suliman/features/store/screens/campaign_screen.dart';
...
import 'package:suliman/util/html_type.dart';
import 'package:suliman/common/widgets/image_viewer_screen.dart';
import 'package:suliman/common/widgets/not_found.dart';
import 'package:suliman/features/cart/screens/cart_screen.dart';
import 'package:suliman/features/category/screens/category_item_screen.dart';
import 'package:suliman/features/chat/screens/chat_screen.dart';
import 'package:suliman/features/chat/screens/conversation_screen.dart';
import 'package:suliman/features/checkout/screens/checkout_screen.dart';
import 'package:suliman/features/payment/screens/offline_payment_screen.dart';
import 'package:suliman/features/checkout/screens/order_successful_screen.dart';
import 'package:suliman/features/payment/screens/payment_screen.dart';
import 'package:suliman/features/payment/screens/payment_webview_screen.dart';
import 'package:suliman/features/coupon/screens/coupon_screen.dart';
import 'package:suliman/features/dashboard/screens/dashboard_screen.dart';
import 'package:suliman/features/favourite/screens/favourite_screen.dart';
import 'package:suliman/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:suliman/features/item/screens/item_campaign_screen.dart';
import 'package:suliman/features/item/screens/item_details_screen.dart';
import 'package:suliman/features/item/screens/popular_item_screen.dart';
import 'package:suliman/features/verification/screens/forget_pass_screen.dart';
import 'package:suliman/features/verification/screens/new_pass_screen.dart';
import 'package:suliman/features/verification/screens/verification_screen.dart';
import 'package:suliman/features/html/screens/html_viewer_screen.dart';
import 'package:suliman/features/interest/screens/interest_screen.dart';
import 'package:suliman/features/language/screens/language_screen.dart';
import 'package:suliman/features/location/screens/access_location_screen.dart';
import 'package:suliman/features/location/screens/pick_map_screen.dart';
import 'package:suliman/features/notification/screens/notification_screen.dart';
import 'package:suliman/features/onboard/screens/onboarding_screen.dart';
import 'package:suliman/features/order/screens/guest_track_order_screen.dart';
import 'package:suliman/features/order/screens/order_details_screen.dart';
import 'package:suliman/features/order/screens/order_screen.dart';
import 'package:suliman/features/order/screens/order_tracking_screen.dart';
import 'package:suliman/features/order/screens/order_tracking_map_screen.dart';
import 'package:suliman/features/order/screens/refund_request_screen.dart';
import 'package:suliman/features/parcel/screens/parcel_category_screen.dart';
import 'package:suliman/features/parcel/screens/parcel_location_screen.dart';
import 'package:suliman/features/parcel/screens/parcel_request_screen.dart';
import 'package:suliman/features/profile/screens/profile_screen.dart';
import 'package:suliman/features/profile/screens/update_profile_screen.dart';
import 'package:suliman/features/store/screens/all_store_screen.dart';
import 'package:suliman/features/store/screens/store_item_search_screen.dart';
import 'package:suliman/features/store/screens/store_screen.dart';
import 'package:suliman/features/store/screens/followed_stores_screen.dart';
import 'package:suliman/features/review/screens/review_screen.dart';
import 'package:suliman/features/review/screens/review_image_viewer_screen.dart';
import 'package:suliman/features/review/domain/models/review_model.dart';
import 'package:suliman/features/search/screens/search_screen.dart';
import 'package:suliman/features/splash/screens/splash_screen.dart';
import 'package:suliman/features/support/screens/support_screen.dart';
import 'package:suliman/features/update/screens/update_screen.dart';
import 'package:suliman/features/review/screens/user_review_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:suliman/features/wallet/screens/wallet_screen.dart';
import 'package:suliman/features/order/screens/invoice_screen.dart';
import 'package:suliman/features/cart/screens/shared_cart_handler.dart';
import 'package:suliman/features/pro/screens/subscription_plan_screen.dart';

import 'package:suliman/features/product_question/screens/my_questions_screen.dart';
import 'package:suliman/features/suggestion/screens/my_suggestions_screen.dart';
import 'package:suliman/features/suggestion/screens/add_suggestion_screen.dart';
import 'package:suliman/features/cart/screens/my_carts_screen.dart';
import 'package:suliman/features/product_question/screens/add_question_screen.dart';
import 'package:suliman/features/shelf/screens/dynamic_shelf_view_all_screen.dart';
import 'package:suliman/features/service/screens/service_screen.dart';
import 'package:suliman/features/service/screens/service_details_screen.dart';
import 'package:suliman/features/service/screens/service_booking_screen.dart';
import 'package:suliman/features/service/screens/service_quotation_screen.dart';
...
import 'package:suliman/features/service/screens/service_booking_tracking_screen.dart';
import 'package:suliman/features/service/screens/service_booking_list_screen.dart';
import 'package:suliman/features/service/screens/service_booking_details_screen.dart';
import 'package:suliman/features/service/domain/models/service_quotation_model.dart';
import 'package:suliman/features/service/screens/service_quotation_list_screen.dart';
import 'package:suliman/features/service/screens/service_quotation_details_screen.dart';
import 'package:suliman/features/trends/screens/trends_screen.dart';
import 'package:suliman/features/global_shopping/screens/global_home_screen.dart';
...
import 'package:suliman/features/global_shopping/screens/global_order_tracking_screen.dart';
import 'package:suliman/features/global_shopping/screens/global_product_detail_screen.dart';
...
class RouteHelper {
  ...
  static const String orderTrackingMap = '/track-order-map';
  ...
  static const String shareCart = '/share-cart';
  static const String addQuestion = '/add-question';
  static const String reviewImageViewer = '/review-image-viewer';
  static const String userReview = '/user-review';
  static const String dynamicShelfItems = '/dynamic-shelf-items';
  ...
  static const String serviceQuotation = '/service-quotation';
  static const String serviceProvider = '/service-provider';
  static const String serviceBookingTracking = '/service-booking-tracking';
  static const String serviceBookingList = '/service-booking-list';
  static const String serviceQuotationList = '/service-quotation-list';
  static const String serviceQuotationDetails = '/service-quotation-details';
  static const String trends = '/trends';

  /// Global Shopping
  static const String globalHome = '/global-home';
  static const String globalCart = '/global-cart';
  static const String globalCheckout = '/global-checkout';
  static const String globalOrderList = '/global-order-list';
  static const String globalOrderTracking = '/global-order-tracking';
  ...
  static String getReviewImageViewerRoute(ReviewModel review, Item item, int index) {
    String reviewData = base64Url.encode(utf8.encode(jsonEncode(review.toJson())));
    String itemData = base64Url.encode(utf8.encode(jsonEncode(item.toJson())));
    return '$reviewImageViewer?review=$reviewData&item=$itemData&index=$index';
  }

  static String getUserReviewRoute() => userReview;
  static String getDynamicShelfItemsRoute(int? shelfId) => '$dynamicShelfItems?shelf_id=$shelfId';
  static String getServicesRoute({int? categoryId}) => '$services${categoryId != null ? '?category_id=$categoryId' : ''}';
  static String getServiceDetailsRoute(int? id) => '$serviceDetails?id=$id';
  static String getServiceBookingRoute(int? id) => '$serviceBooking?id=$id';
  static String getServiceQuotationRoute(int? id) => '$serviceQuotation?id=$id';
  static String getServiceProviderRoute(ServiceProviderModel provider) {
    String data = base64Url.encode(utf8.encode(jsonEncode(provider.toJson())));
    return '$serviceProvider?provider=$data';
  }
  static String getServiceBookingDetailsRoute(int? id) => '$serviceBookingDetails?id=$id';
  static String getServiceBookingTrackingRoute({int? id}) => '$serviceBookingTracking${id != null ? '?id=$id' : ''}';
  static String getServiceBookingListRoute() => serviceBookingList;
  static String getServiceQuotationListRoute() => serviceQuotationList;
  static String getServiceQuotationDetailsRoute(ServiceQuotation quotation) {
    String data = base64Url.encode(utf8.encode(jsonEncode(quotation.toJson())));
    return '$serviceQuotationDetails?quotation=$data';
  }
  ...
  static String getOrderTrackingMapRoute(int? id, String? contactNumber) => '$orderTrackingMap?id=$id&number=$contactNumber';
  ...
  static String getCategoryItemRoute(int? id, String name, {bool isSubSub = false}) {
    List<int> encoded = utf8.encode(name);
    String data = base64Encode(encoded);
    return '$categoryItem?id=$id&name=$data&sub-sub=${isSubSub.toString()}';
  }
  ...
  static String getRateReviewRoute() => rateReview;
  static String getUpdateRoute(bool isUpdate, {bool isOptional = false}) => '$update?update=${isUpdate.toString()}&optional=${isOptional.toString()}';
  ...
  static String getReviewRoute(String? storeID, {String? serviceID, String? storeName, Store? store, Service? service}) {
    String storeData = 'null';
    if(store != null) {
      storeData = base64Url.encode(utf8.encode(jsonEncode(store.toJson())));
    }
    String serviceData = 'null';
    if(service != null) {
      serviceData = base64Url.encode(utf8.encode(jsonEncode(service.toJson())));
    }
    return '$storeReview?storeID=$storeID&serviceID=$serviceID&storeName=$storeName&store=$storeData&service=$serviceData';
  }
  ...
  static String getInvoiceRoute(String? orderID) => '$invoice?id=$orderID';
  static String getParcelCategoryRoute() => parcelCategory;
  static String getParcelLocationRoute(ParcelCategoryModel category, {AddressModel? pickupAddress, AddressModel? destinationAddress}) {
    String data = base64Url.encode(utf8.encode(jsonEncode(category.toJson())));
    String pickup = pickupAddress != null ? '&pickup=${base64Url.encode(utf8.encode(jsonEncode(pickupAddress.toJson())))}' : '';
    String destination = destinationAddress != null ? '&destination=${base64Url.encode(utf8.encode(jsonEncode(destinationAddress.toJson())))}' : '';
    return '$parcelLocation?data=$data$pickup$destination';
  }
  ...
  static String getMyCartsRoute() => myCarts;
  ...
  static String getFollowedStoresRoute() => followedStores;
  ...
  static String getShareCartRoute(String data) => '$shareCart?data=$data';
  ...
  static String getTrendsRoute() => trends;

  static String getGlobalHomeRoute() => globalHome;
  static String getGlobalCartRoute() => globalCart;
  static String getGlobalCheckoutRoute() => globalCheckout;
  static String getGlobalOrderListRoute() => globalOrderList;
  static String getGlobalOrderTrackingRoute(int? orderId) => '$globalOrderTracking?id=$orderId';
  static String getGlobalProductDetailRoute(GlobalProductModel product) {
    String data = base64Url.encode(utf8.encode(jsonEncode(product.toJson())));
    return '$globalProductDetail?product=$data';
  }
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: main, page: () => getRoute(DashboardScreen(
      pageIndex: Get.parameters['page'] == 'home' ? 0 : Get.parameters['page'] == 'favourite' ? 4
          : Get.parameters['page'] == 'cart' ? 3 : Get.parameters['page'] == 'order' ? 2 : Get.parameters['page'] == 'menu' ? 5 : 0,
    ))),
    ...
    GetPage(name: categoryItem, page: () {
      ...
      return getRoute(CategoryItemScreen(
        ...
        categoryName: data,
        isSubSub: Get.parameters['sub-sub'] == 'true',
      ));
    }),
    ...
    GetPage(name: update, page: () => UpdateScreen(isUpdate: Get.parameters['update'] == 'true', isOptional: Get.parameters['optional'] == 'true')),
    ...
    GetPage(name: storeReview, page: () => getRoute(ReviewScreen(
      storeID: Get.parameters['storeID'] == 'null' ? null : Get.parameters['storeID'],
      serviceID: Get.parameters['serviceID'] == 'null' ? null : Get.parameters['serviceID'],
      storeName: Get.parameters['storeName'],
      store: (Get.parameters['store'] != null && Get.parameters['store'] != 'null') ? Store.fromJson(jsonDecode(utf8.decode(base64Url.decode(Get.parameters['store']!.replaceAll(' ', '+'))))) : null,
      service: (Get.parameters['service'] != null && Get.parameters['service'] != 'null') ? Service.fromJson(jsonDecode(utf8.decode(base64Url.decode(Get.parameters['service']!.replaceAll(' ', '+'))))) : null,
    ))),
    ...
    GetPage(name: invoice, page: () {
      return InvoiceScreen(orderId: Get.parameters['id']!);
    }),
    GetPage(name: parcelCategory, page: () => getRoute(const ParcelCategoryScreen())),
    GetPage(name: parcelLocation, page: () {
      return getRoute(ParcelLocationScreen(
    ...
    GetPage(name: myCarts, page: () => const MyCartsScreen()),
    ...
    GetPage(name: reviewImageViewer, page: () {
      ReviewModel review = ReviewModel.fromJson(jsonDecode(utf8.decode(base64Url.decode(Get.parameters['review']!.replaceAll(' ', '+')))));
      Item item = Item.fromJson(jsonDecode(utf8.decode(base64Url.decode(Get.parameters['item']!.replaceAll(' ', '+')))));
      return getRoute(ReviewImageViewerScreen(review: review, item: item, initialIndex: int.parse(Get.parameters['index']!)));
    }),
    GetPage(name: userReview, page: () => getRoute(const UserReviewScreen())),
    GetPage(name: dynamicShelfItems, page: () => getRoute(DynamicShelfViewAllScreen(shelfId: int.parse(Get.parameters['shelf_id']!)))),
    GetPage(name: services, page: () => getRoute(ServiceScreen(categoryId: (Get.parameters['category_id'] != null && Get.parameters['category_id'] != 'null') ? int.parse(Get.parameters['category_id']!) : -1))),
    GetPage(name: serviceDetails, page: () => getRoute(ServiceDetailsScreen(id: int.parse(Get.parameters['id']!)))),
    GetPage(name: serviceBooking, page: () => getRoute(ServiceBookingScreen(serviceId: int.parse(Get.parameters['id'] ?? '0')))),
    GetPage(name: serviceBookingDetails, page: () => getRoute(ServiceBookingDetailsScreen(bookingId: int.parse(Get.parameters['id']!)))),
    GetPage(name: serviceQuotation, page: () => getRoute(ServiceQuotationScreen(serviceId: int.parse(Get.parameters['id'] ?? '0')))),
    GetPage(name: serviceProvider, page: () {
      List<int> decode = base64Decode(Get.parameters['provider']!.replaceAll(' ', '+'));
      ServiceProviderModel data = ServiceProviderModel.fromJson(jsonDecode(utf8.decode(decode)));
      return getRoute(ServiceProviderScreen(provider: data));
    }),
    GetPage(name: serviceBookingTracking, page: () => getRoute(ServiceBookingTrackingScreen(bookingId: (Get.parameters['id'] != null && Get.parameters['id'] != 'null') ? int.parse(Get.parameters['id']!) : -1))),
    GetPage(name: serviceBookingList, page: () => getRoute(const ServiceBookingListScreen())),
    GetPage(name: serviceQuotationList, page: () => getRoute(const ServiceQuotationListScreen())),
    GetPage(name: serviceQuotationDetails, page: () {
      List<int> decode = base64Decode(Get.parameters['quotation']!.replaceAll(' ', '+'));
      ServiceQuotation data = ServiceQuotation.fromJson(jsonDecode(utf8.decode(decode)));
      return getRoute(ServiceQuotationDetailsScreen(quotation: data));
    }),
    GetPage(name: trends, page: () => const TrendsScreen()),

    /// Global Shopping
    GetPage(name: globalHome, page: () => getRoute(const GlobalHomeScreen())),
    GetPage(name: globalCart, page: () => getRoute(const GlobalCartScreen())),
    GetPage(name: globalCheckout, page: () => getRoute(const GlobalCheckoutScreen())),
    GetPage(name: globalOrderList, page: () => getRoute(const GlobalOrderListScreen())),
    GetPage(name: globalOrderTracking, page: () {
      final order = Get.arguments;
      if (order is GlobalOrderModel) {
        return getRoute(GlobalOrderTrackingScreen(order: order));
      }
      return getRoute(const GlobalOrderListScreen());
    }),
    GetPage(name: globalProductDetail, page: () {
      GlobalProductModel product = GlobalProductModel.fromJson(
        jsonDecode(utf8.decode(base64Url.decode(Get.parameters['product']!.replaceAll(' ', '+')))),
      );
      return getRoute(GlobalProductDetailScreen(product: product));
    }),
    GetPage(name: myItems, page: () => getRoute(const MyItemsScreen())),
    GetPage(name: myItemsDetails, page: () {
      final MonthlyOrder? order = Get.arguments is MonthlyOrder ? Get.arguments as MonthlyOrder : null;
      if (order != null) {
