...
class AppConstants {
  ...
  static const double appVersion = 3.5;
  ...
  static const String calculateFbsFeeUri =
      '/api/v1/customer/order/calculate-fbs-fee';
  static const String calculateDeliveryFeeUri =
      '/api/v1/customer/order/calculate-delivery-fee';
  ...
  static const String deliveryManReviewUpdateUri =
      '/api/v1/delivery-man/reviews/update';
  static const String deliveryManReviewDeleteUri =
      '/api/v1/delivery-man/reviews/';
  ...
  static const String preBatchCheckUri =
      '/api/v1/customer/order/pre-batch-check';
  ...
  static const String customerSuggestionListUri =
      '/api/v1/customer/suggestions/list';
  static const String customerSuggestionSubmitUri =
      '/api/v1/customer/suggestions/submit';
  static const String customerSuggestionDeleteUri =
      '/api/v1/customer/suggestions/delete/';
  ...
  static const String servicesProvidersSearchUri =
      '/api/v1/services/providers/search';
  ...
  static const String serviceBookingDetailsUri =
      '/api/v1/services/booking/details';
  static const String serviceBookingCancelUri =
      '/api/v1/services/booking/cancel';
  static const String serviceQuotationPlaceUri =
      '/api/v1/services/quotation/place';
  static const String serviceQuotationListUri =
      '/api/v1/services/quotation/list';
  static const String serviceQuotationAcceptUri =
      '/api/v1/services/quotation/accept';
  static const String serviceReviewSubmitUri =
      '/api/v1/customer/service-reviews/submit';
  ...
  static const String proCustomerSubscribeUri =
      '/api/v1/customer/pro-customer/subscribe';
  static const String proCancelSubscriptionsUri =
      '/api/v1/customer/pro-customer/cancel';
  static const String proActiveOfferUri =
      '/api/v1/customer/pro-customer/active-offer';
  static const String proTermsAndConditionUri =
  ...
  static const String taxiSearchAddressHistory =
      'suliman_taxi_search_address_history';
  ...
  static const String monthlyOrderListUri =
      '/api/v1/customer/monthly-order/list';
  static const String monthlyOrderRemoveUri =
      '/api/v1/customer/monthly-order/remove';
...
// credit
  static const String customerCreditAccountsUri =
      '/api/v1/customer/credit/accounts';
  static const String customerCreditValidateCheckoutUri =
      '/api/v1/customer/credit/checkout-validate';
