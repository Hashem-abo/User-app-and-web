...
import 'package:suliman/helper/notification_helper.dart';
...
import 'package:suliman/util/messages.dart';
...
import 'package:suliman/features/home/widgets/cookies_view.dart';
...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        ...
        projectId: "direct-5689b",
        storageBucket: "stackmart-500c7.appspot.com",
        messagingSenderId: "72955669368",
        appId: "1:491987943015:web:d8bc7ab8dbc9991c8f1ec2"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyBFeHl94rh3st8ssQ_hCobfpnCHcYJsqYs",
        appId: "1:72955669368:android:3d793fcaeb29326e88368d",
        messagingSenderId: "72955669368",
        projectId: "direct-5689b",
      ),
    );
